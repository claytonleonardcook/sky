...
declare module '$env/static/private' {
	export const npm_package_devDependencies_unplugin_svelte_components: string;
	...
	export const npm_package_dependencies_global: string;
	export const _: string;
	export const npm_package_devDependencies_prettier: string;
	export const HOME: string;
	export const npm_package_devDependencies__iconify_json_fa6_solid: string;
	export const npm_config_version_git_tag: string;
	export const LANG: string;
	export const npm_package_scripts_check_format: string;
	export const npm_package_devDependencies_typescript: string;
	export const _JAVA_AWT_WM_NONREPARENTING: string;
	export const XDG_CURRENT_DESKTOP: string;
	export const npm_config_init_license: string;
	export const npm_package_scripts_check_lint: string;
	...
	export const npm_package_devDependencies_vite_plugin_qrcode: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		npm_package_devDependencies_unplugin_svelte_components: string;
		SHELL: string;
		WINDOWID: string;
		COLORTERM: string;
		HYPRLAND_CMD: string;
		...
		npm_package_dependencies_global: string;
		_: string;
		npm_package_devDependencies_prettier: string;
		HOME: string;
		npm_package_devDependencies__iconify_json_fa6_solid: string;
		npm_config_version_git_tag: string;
		LANG: string;
		npm_package_scripts_check_format: string;
		npm_package_devDependencies_typescript: string;
		_JAVA_AWT_WM_NONREPARENTING: string;
		XDG_CURRENT_DESKTOP: string;
		npm_config_init_license: string;
		npm_package_scripts_check_lint: string;
		...
		npm_package_devDependencies_vite_plugin_qrcode: string;
